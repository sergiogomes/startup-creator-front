  ...
  return (
    <Container className="p-3" style={{ background: '#000' }}>
      ...
      {!isAluno ? (
        ...
        {!isProvaRespondida ? (
          <>
            <h1 className="nota center">A prova 7 estará disponível entre os dias 23 até 29 de novembro, às 23H59.</h1>
          {perguntas.map((pergunta, i) => {
            ...
            <Jumbotron className="painel" style={{ background: '#8c6531' }}>
              <Form style={{ background: '#8c6531' }} onSubmit={handleSubmit}>
                <h1 className="pergunta">Insira o código da live informado no dia 23 de novembro de 2021:</h1>
                <fieldset className="alternativasRadius">
                  <Form.Group as={Row} className="mb-3">
                    <Form.Control
                      placeholder=""
