    ...
    <Container className="p-3">
      ...
      { caronas.length > 0 ? 
        <>
          ...
          <img src={'img/loading.gif'} alt="Carona Phone" height="220" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }}/>
        </> }
...
export default CaronaPhoneCadastro;
